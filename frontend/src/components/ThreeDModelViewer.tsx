...
export const ThreeDModelViewer: React.FC<ThreeDModelViewerProps> = ({ modelUrl }) => {
  ...
  useEffect(() => {
    ...
    // Start the camera higher and further back so we never skim the ground.
    ...
    // Keep a comfortable distance so the camera doesn't clip through the ground
    controls.minDistance = 5;
    controls.maxDistance = 20;
    // Focus the orbit around the castle center
